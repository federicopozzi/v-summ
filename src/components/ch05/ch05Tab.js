    ...
    <div className="container-fluid">
      <div className="row ">
        {
                    tabHead.map(({
                      ...
                      <div className="col-3 border-end border-success border-bottom border-top bg-light py-1" key={i}>
                        {title}
      ...
      <div className="row ">
        <div className="col-3 padding">
          {
                        steps.map(({
                          ...
                          <div style={{ height: '5rem' }} className="col-12 border-end border-success border-bottom border-top bg-primary px-2" key={i}>
        ...
        <div className="col-3 padding">
          {
                        tools.map(({
                          ...
                          <div style={{ height: '5rem' }} className={`col-12 border-end border-success border-bottom border-top bg-primary px-2 ${sfondo}`} key={i}>
        ...
        <div className="col-3 padding">
          ...
          <div style={{ height: '5rem' }} className="bianco col-12 border-end border-success border-bottom border-top bg-primary px-2">
            {scraping}
          </div>

          <div style={{ height: '5rem' }} className="col-12 border-end border-success border-bottom border-top bg-primary px-2">
            {
                            dataExploration.map(({
                              pill,
                            }, i) => (
